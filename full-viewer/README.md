...
- The map can show 1, 2, 5, or 10 minute windows. Use the date selector and
  ...
  to the current stream. The timeline uses second-level local system time, shows
  the full day, and prevents today's selection from going beyond current time.
